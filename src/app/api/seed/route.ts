...
export async function POST() {
  try {
    ...
    const cats = await db.insert(categories).values([
      ...
      { name: "عرق خوری", slug: "tea-sets", description: "ست‌های چای‌خوری سرامیکی با طراحی منحصر به فرد", image: "https://images.pexels.com/photos/18426652/pexels-photo-18426652.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" },
      { name: "زیر سیگاری", slug: "decorative", description: "اشیاء تزئینی سفالی برای دکوراسیون داخلی", image: "https://images.pexels.com/photos/18646120/pexels-photo-18646120.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" },
    ]).returning();
